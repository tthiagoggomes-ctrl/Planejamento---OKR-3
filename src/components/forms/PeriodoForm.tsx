  ...
  React.useEffect(() => {
    if (initialData) {
      ...
      if (parentPeriodIdForNew === null) {
        ...
        const defaultQuarterStartDate = new Date(today.getFullYear(), getMonth(today), 1); // Start of current month
        const defaultQuarterEndDate = new Date(today.getFullYear(), getMonth(today) + 1, 0, 23, 59, 59, 999); // End of current month

        form.reset({
          nome: "", // Name will be auto-generated by the other useEffect
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input placeholder="Ex: Anual 2025, Q1 2025" {...field} disabled={isAnnualPeriod} />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
